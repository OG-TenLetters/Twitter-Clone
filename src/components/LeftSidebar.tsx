...
const LeftSidebar = () => {
  return (
    <div>
                <section
          className="sticky top-0 w-[23%] flex flex-col items-stretch 
        h-screen"
        >
          ...
          bg-transparent p-4 text-center hover:bg-white/10 transition 
          duration-200 w-full justify-between">
            <div className="flex items-center space-x-2">
              <div className="rounded-full bg-slate-400 w-12 h-12"></div>
              <div className="text-left text-sm">
                <div className="font-semibold"> Jadon Smith</div>
                <div className="">@TenLetters</div>
              </div>
            </div>
              <div>
                <BsThreeDots />
